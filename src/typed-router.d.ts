...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/BatchBattle': RouteRecordInfo<'/BatchBattle', '/BatchBattle', Record<never, never>, Record<never, never>>,
    ...
    '/TokenImport/smslogin': RouteRecordInfo<'/TokenImport/smslogin', '/TokenImport/smslogin', Record<never, never>, Record<never, never>>,
